...
... compatible with `[mild | moderate | severe]` fatty liver disease.
...
- `[Mild | Moderate | Severe]` fatty liver disease without focal lesion.
- `[Mild | Moderate | Severe]` fatty liver disease with focal fat sparing adjacent to ___. No gross mass.
